...
These types of indirect lost-wax processes share the creation of a core *after* the wax model is made (**figs. 16, 18**, see [GI§2.3](/intro/#S2) for a detailed description).
...
-   Drips may stem from heated pins (see above), from wax slabs being cut by a hot tool (**fig. 60**), or (rarely) from thickening the edges of a hollow direct cast if it is possible to gain access to the interior, such as with the use of a false core (see [I.1§1.2](/vol-1/1/#S1.2) above).
...
-   Drips may stem from heated pins, from wax slabs being cut by a hot tool (**fig. 60**) or (rarely) from thickening the edges of a hollow direct cast if it is possible to gain access to the interior, such as with the use of a false core (see [I.1§1.2](/vol-1/1/#S1.2) above).
...
-   Any tool marks left from the paring-down process may be captured in the metal surface (**fig. 94**, see [I.6§1.1.3](/vol-1/6/#S1.1.3)).
...
-   If wires were used to bind the core they may have become embedded in the inner surface of the bronze (**fig. 96**). Such wires are evidence that the core was formed directly, before the wax, and reinforced in this way. Although our sole written mention of the procedure is in Benvenuto Cellini’s (Italian, 1500–1571) description of the lasagna technique (see [Case Study 5](/case-studies/4/)), this procedure is not necessarily exclusive to the lasagna process.
...
This process shares common features with lost-wax casting, as it entails the use of organic materials (for instance animal and vegetable forms or textiles) that can be fully or partially burned out of the mold (**fig. 11**, see [GI§2.5.1](/intro/#S2)).
...
In sand casting, a special sand is pressed onto the pattern within a sturdy frame structure to create removable sections (**fig. 9**, see [GI§2.4.1](/intro/#S2)). Simple shapes (for example medals and small, low reliefs such as Renaissance plaquettes) may only require a two-piece mold. Complex models will necessitate more complex molds.
...
-   Seam lines develop along mold joints (see **figs. 110, 111, 112, 113, 114, 115, 116, 117** in [Case Study 3](/case-studies/4/)).
...
-   a logical pattern of {% def "plugs" %} or patches of similar shape and size distributed over the entire bronze that would cover core pin holes (**figs. 35, 64**, see [I.4§2.2](/vol-1/4/#S2.2));
...
-   Core vents, also known as lanterns (**figs. 6, 43**), may be visible by radiography (see [GI§2.6.3](/intro/#S2), [Case Study 6](/case-studies/4/)).
...
-   Traces of the mold-making process such as scratches, remains of the molding material, or more rarely drawings or marks may remain on the original statue, indicating that an after-cast has been taken (**figs. 128, 129**, see [I.6§1.4.2](/vol-1/6/#S1.4.2)).
...
-   Tool marks may be diagnostic (**figs. 101, 130,** see [I.6§1.1.1](/vol-1/6/#S1.1.1)).
