...
-   A consecrated sculptural image may contain sacred relics that were deposited inside after casting. To close the aperture, sheet metal is generally mechanically joined and held in place using metal burrs {% def "chiseling" "chiseled" %} around the objlinking ({% objlink 'fig-225, fig-226' %}).
