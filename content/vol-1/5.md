...
Not all {% def "bronze" %} sculptures are {% def "cast (v.)" "cast" %} in one piece. Some are intentionally cast in sections, and these parts are considered “primary castings” (as opposed to subsequent cast-on additions such as decorative elements, repairs, and reworkings, here called “secondary castings”). Casting in parts may reflect a particular {% def "founder" %}’s know-how as well as the limitations of local technology of the period and/or place. It may be done because it is easier, more efficient, or necessary to cast a complex or large work in smaller sections (see notably Case Study 7§4). Smaller elements allow for easier {% def "sprue" "sprueing" %} and limit difficult geometries that may impede metal flow or trap air (see [GI§2.7](/intro/#S2.7)), and they do not require the manipulation of large quantities of molten metal.
