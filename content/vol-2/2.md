...
Organic materials such as varnish, pigments, glue, resins, and a variety of restoration materials may fluoresce visible light when exposed to (invisible) ultraviolet light (UV). Photography of UV-induced visible fluorescence (often misleadingly called UV photography for short) may thus prove useful to visualize such materials on the surface of a sculpture ({% objlink 'fig-191' %}). The method may be used in conjunction with macro photography and photomicrography.
