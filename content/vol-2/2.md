...
In many circumstances, close-up or macro photography will be necessary to resolve details of technical interest. Specialized macro lenses, which are designed to minimize distortion, are preferred for this purpose. The closer-up the image is, the smaller the depth of field will be, and thus the greater importance of using a high f-stop.
...
Organic materials such as varnish, pigments, glue, resins, and a variety of restoration materials may fluoresce visible light when exposed to (invisible) ultraviolet light (UV). Photography of UV-induced visible fluorescence (often misleadingly called UV photography for short) may thus prove useful to visualize such materials on the surface of a sculpture ({% ref 'fig-191' %}). The method may be used in conjunction with macro photography and photomicrography.
