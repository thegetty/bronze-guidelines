...
{% accordion "#### 2.2.1 Optical microscopy (OM)" "s2-2-1" %}
...
[^4]: {% cite "Reedy 1997" %}; {% cite "Woodward 1997" %}; {% cite "Lombardi and Vidale 1998" %}; {% cite "Bewer 2001" %}; {% cite "Lombardi 2002" %}; {% cite "Weisman and Reedy 2002" %}; {% cite "Schmidtling 2008" %}; {% cite "Lombardi 2009" %}; {% cite "Carò 2010" %}; {% cite "Mille et al. 2010" %}; {% cite "Vincent 2014" %}.

[^5]: {% cite "Waksman 2014" %}; {% cite "Léon 2014" %}.

[^6]: {% cite "Holmes and Harbotte 1991" %}; {% cite "Reedy 1991b" %}; {% cite "Lombardi and Vidale 1998" %}; {% cite "Mugnaini et al. 2014" %}.
...
[^9]: {% cite "Mugnaini et al. 2014" %}; {% cite "Castelle, Coquinot, and Bourgarit 2016" %}. However, as early as the 1990s Edilberto Formigli already questioned the fabrication process of the core and its integration within the sculpture’s overall fabrication process ({% cite "Formigli 1993" %}).

[^10]: {% cite "Lombardi and Vidale 1998" %}; {% cite "Gratuze, Blet-Lemarquand, and Barrandon 2001" %}; {% cite "Goemaere et al. 2014" %}; {% cite "Mugnaini et al. 2014" %}.
...
[^14]: {% cite "Holmes and Harbotte 1991" %}; {% cite "Reedy 1997" %}; {% cite "Lombardi and Vidale 1998" %}.

[^15]: {% cite "Lombardi 2009" %}; {% cite "Mugnaini et al. 2014" %}; {% cite "Vincent 2014" %}.

[^16]: {% cite "Smith et al. 2011" %}.

[^17]: {% cite "Calligaro et al. 2000" %}; {% cite "Dran, Calligaro, and Salomon 2000" %}; {% cite "Calligaro et al. 2011" %}; {% cite "Castelle, Coquinot, and Bourgarit 2016" %}.

[^18]: {% cite "Pichon et al. 2014" %}.

[^19]: {% cite "Stone 1981" %}; {% cite "Holmes and Harbotte 1991" %}; {% cite "Lombardi and Vidale 1998" %}; {% cite "Schmidtling 2008" %}; {% cite "Lombardi 2009" %}; {% cite "Mugnaini et al. 2014" %}.

[^20]: {% cite "Bish and Post 1989" %}. 

[^21]: {% cite "Lombardi and Vidale 1998" %}; {% cite "Newman 2006" %}; {% cite "Schmidtling 2008" %}; {% cite "Lombardi 2009" %}; {% cite "Mugnaini et al. 2014" %}; {% cite "Vincent 2014" %}.

[^22]: {% cite "Riederer 2004" %}; {% cite "Velde 2005" %}; {% cite "Reedy 2006" %}; {% cite "Livingood and Cordell 2009" %}; {% cite "Dal Sasso et al. 2014" %}.
...
[^27]: {% cite "Milam, Reedy, and Sussman 1988" %}; {% cite "Weisman and Reedy 2002" %}; {% cite "Reedy 2006" %}; {% cite "Reedy and Meyers 2007" %}.
