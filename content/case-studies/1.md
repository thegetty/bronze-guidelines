...
It also became clear that the deformation and fragmentation in one area of the relief was largely the result of violent and high-speed impacts of a 13 × 13 cm implement—very probably the pile driver used in 1839.
...
**Fig-367: X-ray zoomed to relevant area**
...
**Fig-367: With Wax segments, outline, and borders**
...
**Fig-367: With Wax segments, outline, patches, lost-patches, and rivets**

</section>
<section class="slide" data-title="">

Close examination of the surfaces, aided by cleaning during conservation, showed that the external bronze skin is riddled with endemic {% def "porosity" %} (fine holes that formed in the metal during casting) and repairs. These are even more clearly visible in the radiographs (see {% ref 'fig-367' %} on slide 11).
...
## <span class="cs-category">Interpretation</span> Summary of main technological features observed at the back of the dolphins

The diagram synthesizes the evidence preserved from the various stages of production of the relief beginning with the creation of the wax model. The discrete, indirectly formed sections were joined in the wax (light blue lines). Sprues and hanging rings (blue) were modeled in wax and joined to the back.

**fig-467: With wax segments, joints, and elements**
...
**fig-467: With wax segments, borders, flashing, and core pins**
...
**fig-467: With all four welding layers**

</section>
<section class="slide" data-title="">

And the many flaws were fixed with {% def "cast-on repair" "cast-on repairs" %} (brown) and innumerable patches (green), many of which were reinforced with rivets (dark green).

**fig-467: With cast-on repairs, patches, lost patches and rivets**
