...
(figs. 456, 457, 458){.cs-figure-list .is-print-only}
...
(figs. 84, 86, 441){.cs-figure-list .is-print-only}
...
(figs. 466, 460, 462, 463){.cs-figure-list .is-print-only}
...
(figs. 367, 464, 465){.cs-figure-list .is-print-only}
...
(figs. 290, 468, 380, 381){.cs-figure-list .is-print-only}
