...
## <span class="cs-category">Context:</span> The discovery of the dolphins in Vienne, France
...
{% figuregroup '3' 'fig-440, fig-441, fig-442, fig-443, fig-444, fig-445, fig-446, fig-449, fig-450, fig-451, fig-452, fig-453, fig-454, fig-455' %}

</section>
<section class="slide" data-title="Context: Studies">

## <span class="cs-category">Context:</span> Occasions for technical studies
...
{% annoref fig='fig-448' text='**Fig-448**' %}
...
## <span class="cs-category">Visual examination:</span> Some important new findings
...
{% annoref fig='fig-456' anno='connection-line' text='**Fig-456**' %}
...
{% annoref fig='fig-457' anno='cutout' text='**Fig-457**' %}
...
{% annoref fig='fig-458' anno='pile-driver-hole' text='**Fig-458**' %}

</section>
<section class="slide" data-title="Interpretation: Composition">

## <span class="cs-category">Interpretation 1:</span> Reconsidering the original composition
...
{% annoref fig='fig-459' text='**Fig-459**' %}

</section>
<section class="slide" data-title="Fabrication: Making the Model">

## <span class="cs-category">Evidence of fabrication:</span> How was the wax model made?
...
{% annoref fig='fig-084' anno='fingerprint,stroke-direction' text='**Fig-084**' %}
...
{% annoref fig='fig-086' anno='sprues' text='**Fig-086**' %}

</section>
<section class="slide" data-title="">

The wax heads were made of separate parts that were joined in the wax. This can be seen in the lips, for instance, which appear to have been made up of several discrete sections, which would further confirm the use of an indirect process. The overall even thickness of the bronze walls, which was confirmed by radiography (see slide 14 below) points to the probable use of a wax slab process, as that would offer greater control than other processes such as slush molding.

{% annoref fig='fig-441-cs' region='320,900,1060,750' text='**Fig-441: Zoom in on lips**' %}

</section>
<section class="slide" data-title="Fabrication: Assembly">

## <span class="cs-category">Evidence of fabrication:</span> How were the segments of the relief assembled?
...
{% annoref fig='fig-460' text='**Fig-460**' %}

</section>
<section class="slide" data-title="">

Recent scientific studies and characterizations of ancient welds, with experimental simulations in the laboratory, have shed more light on the long-forgotten process (see **video 12**; [I.5](/vol-1/5/)).

{% annoref fig='vid-12' text='**Vid-12**' %}

</section>
<section class="slide" data-title="">

With its three-plus linear meters of weld joins, the Vienne dolphin relief bears testimony of the extensive application of this complicated method of assembly. And while the remains of the relief represent only a small part of the original sculpture, they provide a window into the exceptional scale and ambition of this work.

{% annoref fig='fig-466' anno='fusion-weld' text='**Fig-466**' %}
...
{% annoref fig='fig-463' text='**Fig-463**' %}
...
{% figuregroup '3' 'fig-462' %}

</section>
<section class="slide" data-title="Fabrication: Structure">

## <span class="cs-category">Evidence of fabrication:</span> Structure of the assemblage using X-radiography
...
{% annoref fig='fig-367' text='**Fig-367**' %}
...
{% annoref fig='fig-367' region='4700,2640,888,577' text='**Fig-367: X-ray zoomed to relevant area**' %}

</section>
<section class="slide" data-title="Interpretation: Casting Plan">

## <span class="cs-category">Interpretation 2:</span> Proposing a casting plan
...
{% annoref fig='fig-367' anno='wax,borders,outline' text='**Fig-367: With Wax segments, outline, and border**' %}

</section>
<section class="slide" data-title="Fabrication: Repairs">

## <span class="cs-category">Evidence of fabrication:</span> How was the cast repaired?
...
{% annoref fig='fig-367' anno='wax,outline,patches,lost-patches,rivets' text='**Fig-367: With Wax segments, outline, patches, lost-patches, and rivets**' %}

</section>
<section class="slide" data-title="">

Close examination of the surfaces, aided by cleaning during conservation, showed that the external bronze skin is riddled with endemic {% def "porosity" %} (fine holes that formed in the metal during casting) and repairs. These are even more clearly visible in the radiographs (see {% ref 'fig-367' %} on slide 14).

{% annoref fig='fig-464' text='**Fig-464**' %}
...
{% annoref fig='fig-465' anno='rivet-holes,rivet-heads' text='**Fig-465**' %}

</section>
<section class="slide" data-title="Interpretation: Features">

## <span class="cs-category">Interpretation 3:</span> Summary of main technological features observed at the back of the dolphins
...
{% annoref fig='fig-467' anno='wax,wax-joints,wax-elements' text='**fig-467: With wax segments, joints, and elements**' %}
...
{% annoref fig='fig-467' anno='wax,borders,flashing,core-pins' text='**fig-467: With wax segments, borders, flashing, and core pins**' %}
...
{% annoref fig='fig-467' anno='welding-overflow,welding-joints,welding-joints-accumulation,feeding-basins' text='**fig-467: With all four welding layers**' %}
...
{% annoref fig='fig-467' anno='cast-on-repairs,patches,lost-patches,rivets' text='**fig-467: With cast-on repairs, patches, lost patches and rivets**' %}
...
{% figuregroup '3' 'fig-468' %}

{% annoref fig='fig-290' text='**Fig-290**' %}
...
{% figuregroup '3' 'fig-380' %}

{% annoref fig='fig-381' text='**Fig-381**' %}
...
{% annoref fig='fig-379' text='**Fig-379: 3D interactive**' %}
