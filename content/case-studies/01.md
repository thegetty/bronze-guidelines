...
>
> • bulk metal analyses by atomic emission spectrometry (ICP-AES): C2RMF using a Perkin-Elmer Optima 3000 SC atomic emission spectrometer; a protocol developed specifically for elemental analysis of cultural heritage copper-based artifacts was used ({{< q-cite "Bourgarit and Mille 2003" >}});
>
...
{{< q-cite "Azéma et al. 2011" >}}

{{< q-cite "Azéma and Mille 2013b" >}}

{{< q-cite "Azéma 2013" >}}

{{< q-cite "Boucher 1964" >}}

{{< q-cite "Mille and Robcis 2012" >}}
