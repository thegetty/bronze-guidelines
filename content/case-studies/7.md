...
This choice of making the mold in small discrete sections will be invisible from the outside, as I can fix whatever evidence there is. However, thin lines can be seen between each on the inside where the sections have been welded together. The pattern of lines in the X-ray image will describe the way I planned the mold and therefore how I chose to overcome future difficulties in the casting process ({% ref 'fig-545' %}). Additional lines may be found where wax sections needed to be further cut down, which we see in the joining of the head and neck of the horse.
