...
<section class="slide ref" data-figure-id="vid-03-cover" data-region="" data-annotation-ids="" data-on-scroll="true">
...
<section class="slide ref" data-figure-id="vid-02" data-region="" data-annotation-ids="" data-on-scroll="true" id="s5">

## 5. A sprueing system adapted to each section

### What does the sprueing system look like? Do you prefer “top fed” or “bottom fed”?

(video 2){.pdf-figure-list}

In casting up the various wax sections, I used two very different methods of sprueing, “top fed” and “bottom fed.” This is simply because some sections present better opportunities for one method over another. For example, the head, legs, and tail can be considered irregular cylinders. By pouring a plaster core into these and placing feeds (the sprues used to direct the bronze into the mold) at the top, they make for very straightforward castings. The panels of the body, on the other hand, are sprued up while still in the mold so as not to cause any distortion in the geometry of the wax. They can be sprued up from the top, but this tends to cause overheating and excessive {% def "porosity" %} at that location. By bottom feeding them, the flow of metal is less turbulent and the heat is dispersed throughout the mold.
...
<section class="slide ref" data-figure-id="fig-085" data-region="" data-annotation-ids="" data-on-scroll="true">

### How does evidence of the core pins show up in the final bronze?

(fig. 85){.pdf-figure-list}
...
<section class="slide ref" data-figure-id="fig-002" data-region="" data-annotation-ids="" data-on-scroll="true" id="s7">

## 7. Different core materials depending on the location in the statue

### What material(s) do you use as core?

(fig. 2){.pdf-figure-list}
...
<section class="slide ref" data-figure-id="fig-118" data-region="" data-annotation-ids="" data-on-scroll="true">

### Does the core leave traces on the finished cast?

(fig. 118){.pdf-figure-list}
...
<section class="slide ref" data-figure-id="fig-548" data-region="" data-annotation-ids="" data-on-scroll="true" id="s11">
...
<section class="slide ref" data-figure-id="vid-10" data-region="" data-annotation-ids="" data-on-scroll="true" id="s12">

## 12. Chasing: different from one edition to another

### How important is chasing for you?

(video 10){.pdf-figure-list}
...
<section class="slide ref" data-figure-id="vid-13" data-region="" data-annotation-ids="" data-on-scroll="true">

### Do you use electric tools?

(video 13){.pdf-figure-list}
...
<section class="slide ref" data-figure-id="fig-033" data-region="" data-annotation-ids="" data-on-scroll="true" id="s14">

## 14. Process duration

### What insights can you offer regarding the time involved for the various steps of the process?

(fig. 33){.pdf-figure-list}

I can give you an outline for the working times or durations used in this casting process, although there is no such thing as a generalized time frame ({% objlink 'table-01' %}). And some steps relate to drying or cooling times where there is nothing to do but sit and wait.
