...
image: figures/case-studies/vid-03-cover.jpg
contributor:
  - id: alacey
  - id: dbourgarit
...
## <span class="section-number">3 </span>Homemade recipes for casting wax
...
In the interior of this bronze sculpture you should see some evidence of the different sprueing choices, but reconstructing the way a bronze has been sprued based on remaining sprue stubs, residual flow patterns of the dross, or oxidized metal in the cast surface (see {% ref 'fig-154' %}, [I.3](/vol-1/3/)), et cetera, would be difficult at best. And of course, if I had chosen to place the sprues on the outer, modeled surface of the wax then no evidence would be left after I reworked the locations of the cut-off sprues to blend in with the surrounding areas ({% ref 'fig-088' %}).

## <span class="section-number">6 </span>Core supports

### What technique(s) do you use to keep a core in position?

I have developed the habit of using carpet tacks as {% def "core supports" %} ({% ref 'fig-547' %}). I used to use stainless steel rods, but they are expensive and can be difficult to get hold of. Carpet tacks, on the other hand, are very cheap and sold at any hardware store. The design of the tack is also perfect for the task. They are thin with sharp points, perfect for piercing the wax, and have flat heads, which assists in their removal after casting.
...
I usually remove as much core as possible, but often some small fragments of material may be left inside. In the case of the double core method, a thin line or minimal {% def "flashing" %} would be visible inside the bronze where the two cores meet ({% ref 'vid-11' %}).

## <span class="section-number">8 </span>The investment: key for a good-quality and clean cast surface
...
## <span class="section-number">10 </span>Gas furnaces versus charcoal hearths
...
## <span class="section-number">11 </span>Welding like crochet
...
## <span class="section-number">14 </span>Process duration
...
## <span class="section-number">15 </span>Closing observations
...
{% figuregroup '3' 'fig-033, fig-376, fig-544, fig-545, fig-021, fig-546, fig-154, fig-088, fig-547, fig-007, fig-548' %}
