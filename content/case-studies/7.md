...
In the interior of this bronze sculpture you should see some evidence of the different sprueing choices, but reconstructing the way a bronze has been sprued based on remaining sprue stubs, residual flow patterns of the dross, or oxidized metal in the cast surface (see {% ref 'fig-154' %}, [I.3](#I.3)), et cetera, would be difficult at best. And of course, if I had chosen to place the sprues on the outer, modeled surface of the wax then no evidence would be left after I reworked the locations of the cut-off sprues to blend in with the surrounding areas ({% ref 'fig-088' %}).
