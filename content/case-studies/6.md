...
{% figuregroup '3' 'fig-529' %}

</section>
<section class="slide" id="slide-02" data-title="Context: article">

## <span class="slide-num">2</span> Context: The magazine article
...
{% figuregroup '3' 'fig-530' %}

</section>
<section class="slide" id="slide-03" data-title="Context: sculpture">

## <span class="slide-num">3</span> Context: The sculpture
...
## <span class="slide-num">4</span> Main questions motivating the technical study
...
{% figuregroup '3' 'fig-531' %}

</section>
<section class="slide" id="slide-05" data-title="Diagram of sand casting">

## <span class="slide-num">5</span> Diagram of sand casting (based on the Suverkrop article)
...
<section class="slide" id="slide-06" data-title="examination: modeling">

## <span class="slide-num">6</span> Visual examination: Evidence of the original modeling
...
{% figuregroup '3' 'fig-534, fig-535' %}

</section>
<section class="slide" id="slide-07" data-title="examination: sand piece mold">

## <span class="slide-num">7</span> Visual examination: Evidence of the sand piece mold
...
{% figuregroup '3' 'fig-536, fig-537, fig-538' %}

</section>
<section class="slide" id="slide-08" data-title="examination: casting">

## <span class="slide-num">8</span> Visual examination: Evidence of the casting
...
{% figuregroup '3' 'fig-539, fig-540, fig-541' %}

</section>
<section class="slide" id="slide-09" data-title="X-radiography">

## <span class="slide-num">9</span> X-radiography
...
<section class="slide" id="slide-10" data-title="Summary of technical findings">

## <span class="slide-num">10</span> Summary and discussion of technical findings
...
<section class="slide" id="slide-11" data-title="study parameters">

## <span class="slide-num">11</span> Technical study parameters
...
<section class="slide" id="slide-12" data-title="Further questions">

## <span class="slide-num">12</span> Further questions
...
{% figuregroup '3' 'fig-538, fig-543' %}

</section>
<section class="slide" id="slide-12" data-title="Further resources">

## <span class="slide-num">13</span> Further resources
