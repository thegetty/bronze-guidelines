...
>
> 6\. In order to produce a hollow cast, it is necessary to create an internal mold or %%core%%, which will essentially define the thickness of the bronze walls. To make a core, the mold pieces are reassembled in the cope and the drag respectively. Sand is carefully rammed into the hollow impression left by the pattern. Wires or internal %%core supports%%—some in the form of loosely rolled tubes or “core vents”—are laid across the new sand, extending out into the surrounding mold pieces. The cope and drag are joined, uniting the two halves of the sand %%replica%%, then disassembled again to remove the sculpture.
>
...
>
> 9\. The cope and drag are reassembled and locked together. The metal alloy, which has in the meantime been liquefied, is %%poured%% into the mold.
>
