...
{% ref fig='fig-505-dupe' text='' onscroll='true' %}
...
The {% ref fig='fig-126' text='X-ray radiographs' onscroll='true' %} confirm that the figurines, including the largest ones (30 cm tall) are mostly solid, with open, quadrangular pedestals.
...
Close examination of {% def "punch" %} marks (0.8 mm diameter) by digital microscopy revealed that the smooth, compressed surface inflected by the punch and the dimple of displaced metal around the edge resulted from cold working. In addition, on one statue, {% ref fig='fig-286' text='a 3D reconstruction of the dots' onscroll='true' %} and consequently of the active part of the punch showed a systematic defect in the sphere, clearly testifying to the use of the same tool for all the motifs investigated.
...
Access to a neutron reactor allowed for the {% ref fig='fig-404' text='neutron radiography and tomography' onscroll='true' %} (see [II.3§3](/vol-2/3/#s3)) of several Javanese sculptures that still preserved their consecration materials embedded in metal matrices. This works because metals such as copper, tin, and lead may be X-ray opaque, but they are relatively transparent to neutrons.
...
Inductively coupled plasma atomic emission spectrometry (ICP-AES; see [II.5§3.1](/vol-2/5/#s3-1)) analysis of {% ref fig='fig-517' text='the bulk metal composition of the bronzes' onscroll='true' %} revealed that most of the thirty-nine statues analyzed are made of unleaded bronze alloys—copper-tin alloys with less than 2–3wt% lead. Zinc is present only in traces. With some variations, median values for each time period are higher than 8wt%. Nine statues have relatively high (12–20wt%) tin content.
...
ICP-AES allowed us to determine that the main {% ref fig='fig-518-dupe' text='impurities' onscroll='true' %} found in these alloys are silver, arsenic, iron, nickel, sulfur, and antimony.
...
In all of the Indonesian statues {% ref fig='fig-510-dupe' text='investigated' onscroll='true' %}, even the largest ones, the figures themselves are mostly solid. All were made via lost-wax casting, with extensive modeling and assembling work on the wax. All were originally likely consecrated with sacred objects, and therefore have a cavity in the supporting pedestal or cushion.

The systematic use of a liquefied metal, namely a tin-based alloy, to seal the consecration deposits constitutes another consistent feature of Indonesian production. Copper-based sheets hammered over the base are often encountered for other Buddhist statues, notably in Tibet ({% cite "Reedy 1991a" %}) and China ({% open 'fig-225, fig-226' %}).
