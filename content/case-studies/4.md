...
{% figuregroup '3' 'fig-067, fig-504, fig-505, fig-506, fig-507, fig-508, fig-509' %}

</section>
<section class="slide" id="slide-02" data-title="main questions">

## <span class="slide-num">2</span> The main questions
...
<section class="slide" id="slide-03" data-title="technique: Lost-wax">

## <span class="slide-num">3</span> Casting technique: Lost-wax casts with numerous wax assemblies
...
{% figuregroup '3' 'fig-054, fig-067, fig-508, fig-509' %}

</section>
<section class="slide" id="slide-04" data-title="technique: Solid-cast">

## <span class="slide-num">4</span> Casting technique: Solid-cast figures
...
{% figuregroup '3' 'fig-126, fig-510' %}

</section>
<section class="slide" id="slide-05" data-title="evidence of cold work">

## <span class="slide-num">5</span> Visual evidence of extensive cold work
...
{% figuregroup '3' 'fig-067, fig-276, fig-508, fig-511' %}

</section>
<section class="slide" id="slide-06" data-title="Engraving">

## <span class="slide-num">6</span> Engraving, as suggested by reflectance transformation imaging (RTI)
...
{% figuregroup '3' 'fig-241' %}

</section>
<section class="slide" id="slide-07" data-title="Metal punching">

## <span class="slide-num">7</span> Metal punching confirmed by digital microscopy
...
{% figuregroup '3' 'fig-285, fig-286' %}

</section>
<section class="slide" id="slide-08" data-title="engraving over preparatory drawing">

## <span class="slide-num">8</span> Metal engraving over preparatory drawing on wax confirmed by digital microscopy
...
{% figuregroup '3' 'fig-067, fig-273, fig-512' %}

</section>
<section class="slide" id="slide-09" data-title="Cavity filling">

## <span class="slide-num">9</span> Cavities filled with dense material
...
{% figuregroup '3' 'fig-513' %}

</section>
<section class="slide" id="slide-10" data-title="Consecration deposits">

## <span class="slide-num">10</span> Consecration deposits revealed from below
...
{% figuregroup '3' 'fig-054, fig-508, fig-509, fig-514' %}

</section>
<section class="slide" id="slide-11" data-title="Consecration deposits">

## <span class="slide-num">11</span> Consecration deposits revealed by neutron radiography and tomography
...
{% figuregroup '3' 'fig-400, fig-401, fig-515, fig-516' %}

{% figuregroup '3' 'fig-403, fig-404' %}

</section>
<section class="slide" id="slide-12" data-title="Alloy composition">

## <span class="slide-num">12</span> Alloy composition
...
{% figuregroup '3' 'fig-517' %}

</section>
<section class="slide" id="slide-13" data-title="Impurities">

## <span class="slide-num">13</span> Impurities in the metal
...
{% figuregroup '3' 'fig-518' %}

</section>
<section class="slide" id="slide-14" data-title="Summary">

## <span class="slide-num">14</span> Summary of findings: Consistent features of Indonesian production
...
{% figuregroup '3' 'fig-067, fig-126, fig-510, fig-517' %}

</section>
<section class="slide" id="slide-15" data-title="Summary">

## <span class="slide-num">15</span> Summary of findings: Toward a chronological and stylistic serialization supported by metal composition
...
<section class="slide" id="slide-16" data-title="Summary">

## <span class="slide-num">16</span> Summary of findings: Alloy connections between Java and mainland Southeast Asia
...
{% figuregroup '3' 'fig-508, fig-520, fig-521, fig-522' %}

</section>
<section class="slide" id="slide-17" data-title="Summary">

## <span class="slide-num">17</span> Summary of findings: Characterization of consecration deposits thanks to neutron tomography
...
## <span class="slide-num">18</span> Synopsis of technical parameters
