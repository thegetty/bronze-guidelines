...
{% figure 'fig-516' 'is-65-percent-width' %}
...
The systematic use of a liquefied metal, namely a tin-based alloy, to seal the consecration deposits constitutes another consistent feature of Indonesian production. Copper-based sheets hammered over the base are often encountered for other Buddhist statues, notably in Tibet ({% cite "Reedy 1991a" %}) and China ({% objlink 'fig-225, fig-226' %}).
