...
Metal {% def "seam lines" %} invariably developed along mold {% ref fig='fig-501' text='joints' onscroll='true' %} on the exterior surface of the cast object. Some were ingeniously incorporated into the design as raised, decorative flanges. Others were removed during the finishing process, but often traces can still be detected on the surface. One such seam line can be recognized running along the top of the elephant’s trunk and continuing as a raised linear feature between the elephant’s forehead and the rim of the vessel opening (fig. 501).

</section>
<section class="slide">

Visual and microscopic {% ref fig='fig-116' text='examination' onscroll='true' %} allowed us to identify the traces of mold joints across the surfaces of both vessel and lid, and thereby attempt to reverse engineer the design of the piece mold segments, which add up to at least a dozen for the main body of the vessel alone (fig. 116).

</section>
<section class="slide">

It was determined that the hollow of the vessel’s body was defined by a core inside the belly that reached up to the oval rim of the opening and into the trunk, but did not extend into the legs {% ref fig='fig-116' region='200,1500,1300,1300' text='(A)' onscroll='true' %} (figs. 111, 116).
...
On the outside, two main mold sections bisected the elephant vertically, running up the tail, along the middle of the back to the back of the ears, and perpendicularly across the top of the head and out over the ears {% ref fig='fig-116' region='200,1300,2460,1630' text='' onscroll='true' %} \(C) (figs. 110, 111, 116).
...
A large mold section ran along the belly, including the insides of the legs and the lower lip {% ref fig='fig-116' region='2000,1250,670,1100' text='(D)' onscroll='true' %} (figs. 112, 116).
...
Two vertical face molds ran down the front of the ears and across the top of the trunk and include the exterior of the tusks {% ref fig='fig-116' region='250,700,2440,1000' text='(E)' onscroll='true' %} (figs. 113, 116).
...
For the lid, two main mold sections were used for either side of the body, including the ear, trunk, tail, and ridge down the tail {% ref fig='fig-117' region='670,1250,1130,1130' text='(H)' onscroll='true' %} (figs. 115, 117).
...
A core filled the space inside the legs and under the tail and trunk (K) (figs. 114, 117).

Another core (I) filled the underside of the lid using core extensions to secure its attachment to the bottom mold section (J). The holes in the {% def "cast (n.)" "cast" %} rim locate the extensions’ positions (figs. 114, 117). {% ref fig='fig-117' region='260,680,1400,450' text='' onscroll='true' %}
