...
{% figuregroup '3' 'fig-500' %}

</section>
<section class="slide" id="slide-02" data-title="Context">

## <span class="slide-num">2</span> Context
...
## <span class="slide-num">3</span> The main questions
...
<section class="slide" id="slide-04" data-title="Piece-mold Casting">

## <span class="slide-num">4</span> Piece-mold casting
...
<section class="slide" id="slide-05" data-title="Evidence on the vessel">

## <span class="slide-num">5</span> Evidence for piece molding on the vessel
...
{% figuregroup '3' 'fig-110, fig-111, fig-116' %}
...
{% figuregroup '3' 'fig-112, fig-113, fig-116' %}

</section>
<section class="slide" id="slide-06" data-title="Evidence on the lid">

## <span class="slide-num">6</span> Evidence for piece-molding on the lid
...
{% figuregroup '3' 'fig-114, fig-115, fig-117' %}

</section>
<section class="slide" id="slide-07" data-title="Evidence of core material">

## <span class="slide-num">7</span> Evidence of core material
...
{% figuregroup '3' 'fig-111, fig-112' %}

</section>
<section class="slide" id="slide-08" data-title="Radiographic evidence">

## <span class="slide-num">8</span> Radiographic evidence
...
{% figuregroup '3' 'fig-502' %}

</section>
<section class="slide" id="slide-09" data-title="Decorative elements">

## <span class="slide-num">9</span> Decorative elements
...
{% figuregroup '3' 'fig-503' %}

</section>
<section class="slide" id="slide-10" data-title="Condition">

## <span class="slide-num">10</span> Condition
...
{% figuregroup '3' 'fig-500, fig-503' %}

</section>
<section class="slide" id="slide-11" data-title="Summary">

## <span class="slide-num">11</span> Summary of findings
...
{% figuregroup '3' 'fig-116' %}

</section>
<section class="slide" id="slide-12" data-title="Synopsis">

## <span class="slide-num">12</span> Synopsis
