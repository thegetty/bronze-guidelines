...
Clear traces of {% def "lost-wax casting" %} include the modeling of details such as the {% ref fig='fig-070' text='vine leaf and grapes' onscroll='true' %} held by Abundance.
...
Whereas in most sixteenth- and seventeenth-century {% ref fig='fig-274' text='Parisian bronzes' onscroll='true' %}, two sizes of inclusions coexist (very small inclusions of around 5 µm in diameter and much larger ones, up to 150 µm in diameter), in the allegories only the large inclusions are present (100–200 µm).
