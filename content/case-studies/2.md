...
Aquamanilia are {% ref fig='fig-469' text='zoomorphic or anthropomorphic vessels' onscroll='true' %} for the washing of hands at the table. {% def "cast (v.)" "Cast" %} from copper alloys, they emerged as a distinct artistic form in the twelfth century in Lower Saxony and continued to be fabricated in various areas of Germany for the next three centuries.

</section>
<section class="slide">

They were filled via lidded openings, generally at the tops of the animal’s or rider’s head, with the {% ref fig='fig-469' region='1230,280,880,880' text='spouts either integrally cast as part of the figure’s mouth' onscroll='true' %} or separately fabricated as a spigot and mechanically set into its chest.

</section>
<section class="slide">

They represent an important stage in the evolution of European casting technology, being the first hollow, fully three-dimensional {% ref fig='fig-471' text='sculptural forms' onscroll='true' %} produced since antiquity. More than three hundred aquamanilia are known to have survived through the centuries, some inspiring nineteenth-century {% def "replicas" %}, and all are unique.
...
- How were these {% ref fig='fig-470' region='880,350,983,983' text='fantastical objects' onscroll='true' %} fabricated?
...
An internal {% def "armature" %} would help to support the weight of the clay, and evidence for the same was found in larger and more complex structures. After casting, the {% ref fig='fig-474' text='core material' onscroll='true' %} and armature were generally removed to clear the hollow of the vessel for use.
...
{% ref fig='vid-05' text='' onscroll='true' %}
...
Once the modeling was complete, metal {% def "core pins" %} were partially inserted through the wax and into the core to secure the registration of the aquamanile’s core within its outer mold or investment (see video 5). Next, the model would be {% ref fig='vid-08' text='fitted with a network' onscroll='true' %}  of {% def "sprues" %} through which to melt out the wax, feed the liquefied metal into the mold, and allow the gas and air to escape.
...
When possible, connections helping with that flow were integrated into the design of the sculptural form itself, as can be seen {% ref fig='fig-484' text='in the falconer' onscroll='true' %}.
...
{% ref fig='fig-489' text='' onscroll='true' %}
...
Imperfections and casting flaws seem to have been an anticipated outcome for medieval metalworkers. And the replication experiment ended up with a few as well. Theophilus suggests using a localized lost-wax casting process for {% ref fig='fig-490' anno='cast-on-repair' text='making repairs' onscroll='true' %}. “If there is any flaw, due to neglect or accident, . . . thin out that place by filing around it. Apply wax and likewise add clay on top and when it is dry, heat it, and so pour over it until the liquid bronze flows into that place and what you have poured on top adheres. If, when you examine it, it is not strong enough, solder with burnt wine-tone and the filings of mixed silver and copper as we have described above.”

</section>
<section class="slide">

Many of the aquamanilia show evidence of such {% ref fig='fig-180' anno='cast-on-repair' text='cast-in repairs' onscroll='true' %}. The metal-to-metal join lines are generally faint on the outer surface, but the denser masses of metal that flowed into the hollowed core area are clearly defined in the X-rays.
...
{% ref fig='fig-499' text='' onscroll='true' %}
