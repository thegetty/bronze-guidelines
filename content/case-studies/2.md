...
<section class="slide ref" data-figure-id="fig-473" data-region="" data-annotation-ids="" data-on-scroll="true">

## Lost-wax casting

(fig. 473){.pdf-figure-list}
...
(fig. 474, video 4){.pdf-figure-list}
...
Once the modeling was complete, metal {% def "core pins" %} were partially inserted through the wax and into the core to secure the registration of the aquamanile’s core within its outer mold or investment (see [video 5](/visual-atlas/v05/)). Next, the model would be fitted with a network of {% def "sprues" %} through which to melt out the wax, feed the liquefied metal into the mold, and allow the gas and air to escape.
