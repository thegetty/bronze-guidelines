...
#### [1.2.1 Unavoidable imperfections inherent to the casting process]{.ul}
...
#### [1.2.2 Avoidable defects occurring before the casting]{.ul}
...
#### [1.2.3 Avoidable defects occurring during the refinishing of the cast]{.ul}
...
#### [1.2.4 Damage that may occur during the lifetime of the sculpture]{.ul}
...
#### [1.3.4 Distortions due to mold and/or core shift]{.ul}
...
#### [1.3.5 Heterogeneous alloy composition]{.ul}
