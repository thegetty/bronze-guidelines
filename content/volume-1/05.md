...
[^1]: Separate casting may be part of serial production systems, as seen in a number of cultures, including Khmer Angkorian period ({{< q-cite "Bourgarit et al. 2003" >}}), and nineteenth-century bronze %%editions%% in France ({{< q-cite "Lebon 2003" >}}, 45). It can also be used to allow iconographic flexibility, as seen for example with Roman imperial statuettes ({{< q-cite "Hill 1982" >}}, kindly advised by S. Descamps) and in sculptures by Hubert Le Sueur (French, ca. 1580–1658) and contemporaries, whose small equestrian sculptures had interchangeable heads (see for example {{< q-cite "Evelyn 2000" >}}, 144–45; {{< q-cite "Leithe-Jasper 1986" >}}, 246–53, cat. nos. 66a and b [Manfred Leithe-Jasper]).
