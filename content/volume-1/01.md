...
contributor:
  ...
  - id: pmotture
  - id: dbourgarit
additional contributors: Denise Allen, Valérie Carpentier, Annabelle Collinet, Pete Dandridge, Nicolau Escanilla Artigas, Susanne Gänsicke, Laurence Garenne-Marot, Arlen Heginbotham, Andrew Lacey, Elsa Lambert, Susan La Niece, Chandra L. Reedy, Annick Texier, Jeremy Warren
...
#### [1.1.1 Evidence on the outer surface]{.ul}
...
#### [1.1.2 Evidence on the inner surface (of hollow casts)]{.ul}
...
#### [1.1.3 Radiographic evidence]{.ul}
...
#### [1.2.1 Evidence on the outer surface]{.ul}
...
#### [1.2.2 Evidence on the inner surface (or verso of a relief)]{.ul}
...
#### [1.2.3 Radiographic evidence]{.ul}
...
#### [1.3.1 Evidence on the outer surface]{.ul}
...
#### [1.3.2 Evidence on the internal surface]{.ul}
...
#### [1.3.3 Radiographic evidence]{.ul}
...
#### [1.4.3 Radiographic evidence]{.ul}
...
#### [1.5.1 Evidence on the external surface]{.ul}
...
#### [1.5.2 Radiographic evidence]{.ul}
...
#### [2.1.1 Evidence on the outer surface]{.ul}
...
#### [2.1.2 Evidence on the inner surface]{.ul}
...
#### [2.1.3 Radiographic evidence]{.ul}
...
#### [2.2.1 Evidence on the outer surface]{.ul}
...
#### [2.2.2 Evidence on the inner surface]{.ul}
...
#### [2.2.3 Radiographic evidence]{.ul}
